...
class KLSGD(torch.optim.Optimizer):
    def __init__(self, params, robust=True, lr=1e-3, reg=0.5, adam=False, 
                 alg4=False, alg5=False, alg6=False, alg7=False, alg8=False,
                 alg9=False, alg10=False, alg11=False, alg12=False, alg13=False):
        if lr < 0.0:
...
def train_and_evaluate(model, optimizer, loss_fn, save_dir, train_dataloader, val_dataloader, epochs, step_size, early):
