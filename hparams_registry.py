...
def _hparams(algorithm, dataset, random_seed):
    ...
    elif algorithm == "KLSGD_ERM":
        _hparam('reg', 0.5, lambda r: r.uniform(0.1, 5.0))
        # _hparam('robust', True, lambda r: False)
    ...
    if dataset in SMALL_IMAGES:
        _hparam('batch_size', 64, lambda r: int(2**r.uniform(3, 7)))
    elif algorithm == 'ARM':
